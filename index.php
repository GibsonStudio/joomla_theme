...
<body class="background">
  ...
  <div id="header-w">
      ...
      <div class="logo-container">
          <div class="logo"><a href="<?php echo $this->baseurl ?>/"><img src="<?php echo $this->baseurl; ?>/templates/<?php echo $this->template; ?>/images/logo.png" alt="logo" ></a></div>
      </div> <!-- .logo-container -->
			<nav class="clearfix"><div id="nav"><jdoc:include type="modules" name="mainmenu" style="none" /></div></nav>
		</div> <!-- #header -->
	</div><!-- #header-w -->
